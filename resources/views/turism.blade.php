...
<header class="masthead d-flex align-items-center"
        style="background: linear-gradient(90deg, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0) 100%), url(assets/img/zamek-lublin.jpg); .btn-primary.--bs-btn-bg #cd853f;
...
--bs-btn-hover-border-color: #a0522d; ">
    <div class="container px-4 px-lg-5 text-center">
        <h1 class="mb-1" style="text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black; color: white">
            Lublin</h1>
        <h3 class="mb-5" style="text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black; color: white"><em>ponad
                700 lat historii
            </em></h3>
...
<section class="content-section bg-light" style="padding-top: 2.5rem; padding-bottom: 2.5rem" id="about">
    <div class="container px-4 px-lg-5 text-center">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-auto">
                <h2>Turystyka w Lublinie: Historia, Kultura i Niezapomniane Wrażenia
                </h2>
                <p class="lead mb-5">
                    Lublin, miasto o ponad 700-letniej historii, zachwyca turystów swoim niepowtarzalnym urokiem.
                    Malownicze Stare Miasto, z majestatycznym Zamkiem Lubelskim i urokliwymi kamienicami, przenosi
                    odwiedzających w czasie, odkrywając bogatą przeszłość miasta. Liczne muzea, takie jak Muzeum Wsi
                    Lubelskiej czy Państwowe Muzeum na Majdanku, pozwalają zgłębić zarówno lokalną kulturę, jak i trudne
                    losy regionu.
                    <br><br>
                    Miasto kusi również różnorodnymi festiwalami, takimi jak Carnaval Sztukmistrzów czy Noc Kultury,
                    które przyciągają artystów i turystów z całego świata. Spacerując urokliwymi uliczkami, odkryjesz
                    klimatyczne kawiarnie, parki pełne zieleni oraz wyjątkowe punkty widokowe.
                    <br><br>
                    Lublin to miejsce, gdzie tradycja spotyka się z nowoczesnością, oferując niezapomniane wrażenia dla
                    każdego odwiedzającego. Przyjedź i odkryj piękno tego niezwykłego miasta!
                </p>
            </div>
        </div>
    </div>
